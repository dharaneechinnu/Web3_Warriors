        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <Link
                to="/login"
                className="text-primary-600 hover:text-primary-700 px-4 py-2 rounded-lg transition-colors font-medium"
              >
                Sign In
              </Link>
              <Link
      ...
      {isOpen && (
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              to="/dashboard"
              className="block text-gray-600 hover:text-primary-600 px-3 py-2 rounded-md transition-colors"
            >
              Dashboard
            </Link>
            <Link
            ...
            <div className="pt-4 pb-3 border-t border-gray-100">
              <Link
                to="/login"
                className="block text-primary-600 hover:text-primary-700 px-3 py-2 rounded-md transition-colors font-medium"
              >
                Sign In
              </Link>
              <Link
                to="/register"
                className="block bg-primary-500 text-white px-3 py-2 rounded-md hover:bg-primary-600 transition-colors font-medium mt-2"
              >
                Sign Up
              </Link>
            </div>
