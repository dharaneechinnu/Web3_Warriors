    ...
    try {
      ...
      if (response.ok && data) {
        ...
        if (loginResult.success) {
          const from = location.state?.from?.pathname || '/learner-home';
        ...
        if (data.needsVerification) {
          navigate('/verify/learner', { state: { email: data.email || formData.email } });
          return;
        }
    ...
    <LoginContainer>
      ...
      >
        ...
        <AuthLinks>
          ...
          <AuthLink to="/register/learner">Create Learner Account</AuthLink>
          <AuthLink to="/login/mentor">Sign in as Mentor</AuthLink>
        </AuthLinks>
      </LoginCard>
    </LoginContainer>
  );
